...
while t < duration:
        ...
        t = time() - start
        print(t)
        group_command1.position = 0 # a * sin(w * t + 0 * d)
        group_command1.velocity = 0 # 1.5 #sin((w * t))
        ...
        group_command3.position = 0 # a * sin(w * t + 4 * d)
        group_command3.velocity = 0 # 1.5
        ...
        group_command5.position = 0 # a * sin(w * t + 4 * d)
        group_command5.velocity = 0 # 1.5
